  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System: Streamlining Healthcare, One Appointment at a Time. Experience hassle-free scheduling, instant confirmations, and seamless interactions with your healthcare provider."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System: Streamlining Healthcare, One Appointment at a Time. Experience hassle-free scheduling, instant confirmations, and seamless interactions with your healthcare provider.`}
            </Text>
            <Box
